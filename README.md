...
```bash
git clone https://github.com/GigaSoulTouch/technical-writing-236.git
cd technical-writing-236
python setup.py
```
...
```bash
git clone https://github.com/GigaSoulTouch/technical-writing-236 ~/repos/technical-writing
...
<!-- Last updated: 2026-06-06 15:08:16 -->
